...
const Hero = () => {
  return (
    <div className="min-h-screen    text-gray-600 flex flex-col lg:flex-row items-center justify-center lg:justify-start text-center lg:text-left p-5 pt-24">
  ...
  <img
    src={belal}
    alt="Belal Uddin"
    className="h-44 w-44 lg:h-[500px] lg:w-[500px] rounded-full object-cover shadow-xl filter grayscale hover:grayscale-0 transition duration-300"
  />
</div>
      ...
      >
        <p className="text-2xl md:text-3xl lg:text-4xl text-gray-500  ">
          <span className="filter grayscale hover:grayscale-0 transition-all duration-300 ease-in-out "> ✌️</span> Hi There! I'm Belal Uddin
        </p>

        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold">
          A <span className=" text-gray-500">Front-End Dev</span>
        </h1>
        ...
        <p className="max-w-xl text-base md:text-lg lg:text-xl text-gray-500">
